...
<img src='http://i.imgur.com/ixeoQnn.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
<img src='http://i.imgur.com/55RTq7f.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
Implementing advances filters was challenging at first and I did not think about the use of models and creation of a Filters class. 
However, soon after, I realized that the best way would have been to use a filter class as a model and implement Parcelabel. This would make the code more efficient and more organized. 
I definitely understand and recognize the use of models better after this assignment especially because I did not use it and therefore, realized its importance.  
